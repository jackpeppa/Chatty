...
#
FILE_DA_CONSEGNARE=Makefile chatty.c message.h ops.h stats.h config.h client.c connections.c \
				icl_hash.h icl_hash.c lib_utils.h lib_utils.c listener.c queue.c queue.h stats.c sysmacro.h threads.c threads.h \
		   DATA/chatty.conf1 DATA/chatty.conf2 DATA/script.sh connections.h DATA/relazione.pdf \
			 testconf.sh testfile.sh testgroups.sh testleaks.sh teststress.sh
# inserire il nome del tarball: es. NinoBixio
TARNAME=GiacomoPeparaio
...
OBJECTS		= lib_utils.o queue.o threads.o connections.o stats.o icl_hash.o listener.o
